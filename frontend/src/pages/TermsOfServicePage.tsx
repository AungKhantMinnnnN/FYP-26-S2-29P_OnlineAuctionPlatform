...
// (site_content, slug = "terms") so admins can edit or add sections.
...
function SectionList({ sections }: { sections: PageSection[] }) {
  if (sections.length === 0) {
    return (
      <p className="text-sm text-slate-400">These terms have no sections yet.</p>
    )
  }
  return (
      ...
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-slate-500 sm:text-base">
            These terms govern your use of the AuctionHub online auction platform. By using the
            platform, you agree to the terms set out below.
          </p>
