...
// the database (site_content, slug = "privacy") so admins can edit all of it.
...
export default function PrivacyPolicyPage() {
  ...
  return <PolicyPageContent content={data} />
}

function PolicyPageContent({ content }: { content: PageContent }) {
