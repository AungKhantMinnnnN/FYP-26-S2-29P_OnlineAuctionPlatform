    ...
    <div className="flex flex-col h-full py-4">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${
                isActive
                  ? 'bg-accent-50 text-accent-700 shadow-sm ring-1 ring-accent-100 dark:bg-accent-950/40 dark:text-accent-300 dark:ring-accent-900/50'
      ...
      <div className="px-2 mt-auto">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-700 transition-colors hover:bg-slate-100 hover:text-slate-950 w-full dark:text-slate-300 dark:hover:bg-slate-900 dark:hover:text-slate-50"
        >
          <LogOut size={18} />
          Log Out
        </button>
