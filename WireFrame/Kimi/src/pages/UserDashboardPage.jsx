        ...
        <div className="grid gap-6 p-6 lg:grid-cols-[1.4fr_0.8fr] lg:p-8">
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row">
              ...
              <Link to="/create-listing" className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition-all hover:-translate-y-0.5 hover:border-accent-200 hover:text-accent-700 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-300 dark:hover:border-accent-800 dark:hover:text-accent-300">
